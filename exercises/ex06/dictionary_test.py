...
def test_empty_dict_invert() -> None:
    """Edge Case: Test invert function when there's no key-value in input dict,
...
def test_one_pair() -> None:
    """Use Case: Test invert function when there is only one pair of key-value,
    invert({'Happy': 'Friday'}) = {'Friday': 'Happy'}.
    """
...
def test_multiple_pairs() -> None:
    """Use Case: Test invert function when there's more than one pair of key-value,
    invert({'Happy': 'Friday', 'Great': 'Saturday', 'Restful': 'Sunday'}) = {'Friday': 'Happy', 'Saturday': 'Great', 'Sunday': 'Restful'}.
    """
...
def test_empty_dict_fc() -> None:
    """Edge Case: Test favorite_color function when there's no key-value in input dict,
...
def test_one_popular_color() -> None:
    """Use Case: Test favorite_color when there's just one most frequently appearing color in input dict,
    favorite_color({"Lenoir": "blue", "Chase": "purple", "Agora": "blue"}) = "blue".
    """
...
def test_tied_popular_color() -> None:
    """Use Case: Test favorite_color when there's a tie for most popular color,
    favorite_color({"Lenoir": "blue", "Chase": "purple", "Agora": "blue", "Bento": "purple", "Cholanad": "red"}) = "blue".
    """
...
def test_empty_list_count() -> None:
    """Edge Case: Test count function when there are no items in the input list,
    count([]) should return {}.
    """
    assert count([]) == {}
...
def test_one_count_for_all_items() -> None:
    """Use Case: Test count function when there's only one count of every item fromm input list,
    count(["panda", "bear", "squirrel", "chipmunk"]) = {"panda": 1, "bear": 1, "squirrel": 1, "chipmunk": 1}.
    """
...
def test_varied_count_items() -> None:
    """Use Case: Test count function when there's varied counts of the items in the input list,
    count(["panda", "bear", "panda", "squirrel", "panda", "bear"]) = {"panda": 3, "bear": 2, "squirrel": 1}.
    """
...
def test_empty_list_alphabetizer() -> None:
    """Edge Case: Test alphabetizer function when there are no items in the input list,
...
def test_one_value_per_letter() -> None:
    """Use Case: Test alphabetizer function when there's only one item from input list that match the first letter in the keys of dict,
    alphabetizer(["skittles", "kitkat", "milkyway", "hershey"]) = {'s': ['skittles'], 'k': ['kitkat'], 'm': ['milkyway'], 'h': ['hershey']}.
    """
...
def test_varied_values_per_letter() -> None:
    """Use Case: Test alphabetizer function when there are varied counts of items from input list that match the first letter in the keys of dict,
    alphabetizer(["skittles", "kitkat", "milkyway", "snickers", "krispies", "kreme"]) = {'s': ['skittles', 'snickers'], 'k': ['kitkat', 'krispies', 'kreme'], 'm': ['milkyway']}.
    """
...
def test_empty_dict_ua() -> None:
    """Edge Case: Test update_attendance function when there are no strs for weekday and student in input,
    update_attendance(attendance_log1, "", "") should return original dict.
    """
